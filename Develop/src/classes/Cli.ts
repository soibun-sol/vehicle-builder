    ...
    inquirer
      ...
      .then((answers) => {
        if (answers.vehicleType === 'Car') {
          ...
          this.createTruck();
        } else if (answers.vehivleType === 'MotorBike'){
  ...
  performActions(): void {
    inquirer
      ...
      .then((answers) => {
        ...
        } else if (answers.action === 'Tow' && this.selectedVehicle instanceof Truck) {
          this.findVehicleToTow(selectedVehicle as Truck);
          return;
           // TODO: add statements to perform the wheelie action only if the selected vehicle is a motorbike
        } else if (answers.action === 'Wheelie' && this.selectedVehicle instanceof Motorbike) {
